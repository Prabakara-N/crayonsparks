...
export const SEEK_AND_FIND_PROMPT = (opts: {
  ...
  return [
    ...
    "Style: clean bold black outlines on pure white, no shading, no grey fills, no color. Plenty of objects and background detail to make finding fun, but keep every listed item clearly visible.",

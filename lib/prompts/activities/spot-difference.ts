// Picture 1 — the original clean B&W line-art scene. Picture 2 (with real
// changes) and the circled answer key are generated from this image.
...
export const SPOT_DIFFERENCE_CHANGES_PROMPT = (opts: { count: number }): string =>
  [
    `Redraw the provided black-and-white line-art scene EXACTLY — same composition, same objects, same positions, same line style — but introduce exactly ${opts.count} clear, visible differences.`,

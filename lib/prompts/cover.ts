...
export const BACK_COVER_PROMPT_TEMPLATE = (opts: {
  ...
  return [
    ...
    "Composition: just two things — a soft textured colored background covering the FULL canvas edge-to-edge with ZERO white margin on ANY side (top, bottom, left, right, all four corners), and one elegant tagline floating in the middle. The colored background must touch all four physical edges of the page; if any pixel near an edge is white or cream that is NOT part of the framed border option, the render is wrong. Calm, spacious, lots of breathing room.",
